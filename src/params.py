...
def params():
    ...
    parser.add_argument('--answer_file', type=str, default='answer.txt', help='model input (answer position)')
    ...
    params.train_answer_file = os.path.join(params.train_dir, params.answer_file)
    ...
    params.dev_answer_file = os.path.join(params.dev_dir, params.answer_file)
    ...
    params.test_answer_file = os.path.join(params.test_dir, params.answer_file)
