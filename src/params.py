...
def params():
    ...
    parser.add_argument('--answer_ner_file', type=str, default='answer_ner.txt', help='ner tag for answer')
    ...
    params.train_answer_ner_file = os.path.join(params.train_dir, params.answer_ner_file)
    ...
    params.dev_answer_ner_file = os.path.join(params.dev_dir, params.answer_ner_file)
    ...
    params.test_answer_ner_file = os.path.join(params.test_dir, params.answer_ner_file)
